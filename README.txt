...
PostsAPI:
   ...
   To test... if the sort is being sorted correctly, then the console will print out either
   "Test passed!" with some details of the sort, or itll output "Test failed!".

Recipes:
	127.0.0.1:5000/recipes
	127.0.0.1:5000/recipes/details/<recipe>
	Add recipes and Update Recipes: Look at cmds.txt
